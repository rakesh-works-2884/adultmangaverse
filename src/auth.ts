    ...
    Credentials({
      ...
      authorize: async (credentials) => {
        try {
          ...
          // Auto-create/authorize the Admin user defined in environment variables
          if (envAdminEmail && envAdminPassword && emailLower === envAdminEmail && inputPassword === envAdminPassword) {
