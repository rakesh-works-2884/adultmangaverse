...
export function AuthCard({
  ...
  return (
    <div className="mx-auto flex w-full max-w-5xl flex-col px-4 py-10 sm:py-16">
      <div className="grid overflow-hidden rounded-3xl border border-border bg-surface shadow-[0_4px_32px_rgb(0_0_0/0.5)] lg:grid-cols-2">
        {/* Brand panel — desktop only */}
        <div className="relative hidden flex-col justify-between overflow-hidden border-r border-white/10 bg-gradient-to-br from-primary/25 via-bg-soft to-bg p-10 shadow-[inset_0_1px_0_0_rgb(255_255_255/0.08)] lg:flex">
